...
BEGIN
    ...
    WHILE i <= 500 DO
        INSERT INTO writing_pads(name, img_url, pad_img_url, price, add_price, category, description)
        VALUES (CONCAT('name', i), CONCAT('product_path', i), CONCAT('product_detail_path', i), 100 + i, 7, 2000 + i, 1, 1, 0);
        SET i = i + 1;
    END WHILE;
END ;;
DELIMITER ;
